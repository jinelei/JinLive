...
<div id="request_container" class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
        <#if status?? && status == 0>
			<form method="POST" action="/live/room/roomset">
	        ...
	        <div class="form-group">
		        <label for="request_room_name" id="request_room_name_label">Room name:</label>
		        <input type="text" maxlength='21' class="form-control" id="request_room_name"
		               name="room_name" onblur="checkEmail()"
		               placeholder="Room name">
	        </div>
			<div class="form-group">
				<label for="request_room_introduce" id="request_room_introduce_label">Room introduce:</label>
				<input type="text" maxlength='21' class="form-control" id="request_room_introduce"
				       name="room_introduce" onblur="checkEmail()"
				       placeholder="Room introduce">
			</div>
